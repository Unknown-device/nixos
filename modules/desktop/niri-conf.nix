  ...
  home.file."${config.xdg.configHome}/niri/config.kdl" = {
    text = ''
      ...
      binds {
          ...
          Super+Alt+L hotkey-overlay-title="Lock the Screen" { spawn "noctalia-shell ipc call sessionMenu toggle"; }
          ...
          Mod+Alt+L { spawn "noctalia-shell" "ipc" "call" "lockScreen" "toggle"; }
      }
    '';
    force = true;
  };
